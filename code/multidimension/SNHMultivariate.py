...
def sgdNeuralHawkesBiVariate(t,nNeurons=50,nEpochs=50,lr=0.01):
    ...
    for epochs in range(1,nEpochs+1,1):
        ...
        for i in range(0,len(rsample),50):
            count=count+1 
            grad = gradientNetwork(tCompressed[:,rsample[i:i+50]],t)
